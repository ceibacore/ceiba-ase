...
class CeibaInstance
{
    public static function get(): CeibaDB
    {
        ...
        if ($resolvedPrefix !== 'ase_') {
            throw new \RuntimeException(
                "[CeibaInstance] Prefix collision detected: expected 'ase_', got '{$resolvedPrefix}'. " .
                "Ensure ASE_DB_PREFIX is set before calling CeibaInstance::get()."
            );
        }
